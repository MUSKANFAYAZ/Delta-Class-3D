      ...
      <header class="topbar">
        ...
        <div class="topbar-actions">
          ...
          <div class="voice-controls item-group" style="display: flex; gap: 8px;">
            ...
            ` : `
              <button id="presentation-button" type="button" class="dc-btn dc-btn-ghost" title="Start Presentation" style="padding: 0.5rem; display: flex; align-items: center; justify-content: center;">
