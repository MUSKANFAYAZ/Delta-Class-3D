...
function addEducationalPoster(scene, { title, subtitle, accentColor, position, rotationY }) {
...
export function createEducationalPosters(scene) {
...
export function setupEnvironment(scene) {
  createWalls(scene);
  createEducationalPosters(scene);
